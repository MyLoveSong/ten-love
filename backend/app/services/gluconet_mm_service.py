...
class GlucoNetMMOptimizer:
    ...
    def _update_model_parameters(self, model: GlucoNet, params: np.ndarray):
        """更新模型参数"""
...
def create_gluconet_service(config: Optional[GlucoNetConfig] = None,
                            use_ssa_optimization: bool = True,
                            use_knowledge_distillation: bool = True,
